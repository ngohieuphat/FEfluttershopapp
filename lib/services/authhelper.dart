...
import 'package:shopappcourse/models/auth_response/login_res_model.dart';
import 'package:shopappcourse/models/auth_response/profile_model.dart';
...
class AuthHelper {
  ...
  Future<ProfileRes> getProfile() async {
    ...
    var url = Uri.parse("${Config.apiUrl}/${Config.getUserUrl}");
